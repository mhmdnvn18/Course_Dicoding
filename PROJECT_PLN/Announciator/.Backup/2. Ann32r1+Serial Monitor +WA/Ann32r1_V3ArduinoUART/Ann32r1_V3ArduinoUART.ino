...
void setup() {                                              
  ...
  delay(2000); // Beri waktu untuk serial siap

  Serial.println("LED TESTED"); // Mencetak pesan ke serial monitor
  mySerial.println("LED TESTED"); // Mencetak pesan ke esp32
  Serial.println("Hello from Arduino Mega"); // Menampilkan pesan yang dikirim di Serial Monitor
  mySerial.println("Hello from Arduino Mega"); // ke esp32
  Serial.println("Message sent to ESP32 via SoftwareSerial"); // Jeda 2 detik sebelum mengirim pesan lagi
  mySerial.println("Message sent to ESP32 via SoftwareSerial"); // ke esp32
  delay(2000);
